...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Sintaxis: \verb|<secreto> GET_METRICS\n|
    ...
    \begin{itemize}
        \item Sintaxis: \verb|<secreto> ADD_USER <usuario> <contraseña>\n|
    ...
    \begin{itemize}
        \item Sintaxis: \verb|<secreto> DEL_USER <usuario>\n|
    ...
    \begin{itemize}
        \item Sintaxis: \verb|<secreto> SET_SECRET <nuevo_secreto>\n|
